...
func Generate(options *options.Options, _ *openapi3.T) (string, error) {
...
func generatePath(options *options.Options) string {
...
func generateAnnotations(options *options.Options) map[string]string {
